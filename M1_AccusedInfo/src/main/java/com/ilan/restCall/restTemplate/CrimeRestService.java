package com.ilan.restCall.restTemplate;
...
public class CrimeRestService {
    ...
    @HystrixCommand(fallbackMethod = "crimeLstFallback", commandKey="HystrixCommandKey")
    ...
    @HystrixCommand(fallbackMethod = "crimeFallback", commandKey="HystrixCommandKey")
